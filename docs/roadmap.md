...
| 2   | Mirror bucket module  | DESIGN-0002 | shared modules family | IMPL there at kickoff — reuse analysis in DESIGN-0002 (family covers baseline; deny statements + `mirror_url` are new; publisher role out of band) | —                        |
